    ...
    while true; do
      ...
      if [[ -n $gpu_id ]]; then
        ...
        CUDA_VISIBLE_DEVICES=$gpu_id nohup python distill_train.py \
          -s "/u/xcui1/data/$arg" \
          -m "/u/xcui1/code/LightGaussian/output/${arg}_${prune_percent}" \
          --start_checkpoint "/u/xcui1/code/LightGaussian/output/$arg/chkpnt30000.pth" \
          --iteration 40000 \
          --eval \
          --teacher_model "/u/xcui1/code/LightGaussian/output/${arg}/chkpnt30000.pth" \
          --new_max_sh 2 \
