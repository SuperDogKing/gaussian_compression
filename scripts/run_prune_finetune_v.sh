      ...
      while true; do
        ...
        if [[ -n $gpu_id ]]; then
          ...
          CUDA_VISIBLE_DEVICES=$gpu_id nohup python prune_finetune.py \
            ...
            -m "/projects/bcjw/xcui1/code/LightGaussian/output/${arg}" \
            --eval \
            --port $port \
            --iteration 35000 \
            --prune_iterations 1 \
            --start_pointcloud "/projects/bcjw/xcui1/code/LightGaussian/output/${run_args}/point_cloud/iteration_30000/point_cloud.ply" \
