...
class Scene:
    ...
    def __init__(
        ...
        # print("Before Load Camera",memory_usage())
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](
                args.source_path, args.images, args.eval, is_train=is_train
            )
        elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")):
            print("Found transforms_train.json file, assuming Blender data set!")
            scene_info = sceneLoadTypeCallbacks["Blender"](
                args.source_path, args.white_background, args.eval, is_train=is_train
            )
        else:
        ...
        # print("Before cameraList_from_camInfos",memory_usage())

        for resolution_scale in resolution_scales:
            # temp comment out
            print("Loading Training Cameras")
            self.train_cameras[resolution_scale] = cameraList_from_camInfos(
                scene_info.train_cameras, resolution_scale, args, is_train
            )
            print("Loading Test Cameras")
            self.test_cameras[resolution_scale] = cameraList_from_camInfos(
                scene_info.test_cameras, resolution_scale, args, is_train
            )
        # print("After Load Camera",memory_usage())

        # print("Before Load ply",memory_usage())
        ...
        print("After Load ply",memory_usage())
